  ...
  <div class="h-full">
      ...
      <div>
          ...
          <div class="relative px-4 sm:px-6 lg:px-8 pb-8 max-w-lg mx-auto" x-data="{ card: true }">
              <div class="bg-white mt-10 mb-5 ml-8 mr-7 px-8 pb-6 rounded-2xl shadow-lg">
                  ...
                  <div class="flex  justify-center mb-6">
                      <div class="relative flex w-full p-1 transition duration-150 border-b-4 border-[#3da496] border-purple-10 hover:transparent    rounded">
