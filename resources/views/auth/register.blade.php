                ...
                <div class="bg-white mt-10 mb-5 ml-8 mr-7 px-8 pb-6 rounded-3xl shadow-lg">
                    ...
                    <div class="flex  justify-center mb-6">
                        <div class="relative flex w-full p-1 transition duration-150  border-purple-10 hover:transparent    rounded">
                            ...
                            <button class="relative flex-1 text-lg  border-b-4 border-b-gray-200  font-medium text-gray-600/50 p-1 transition duration-150 ease-in-out focus:outline-none  focus-visible:ring-2" @click.prevent="card = false">Registrarse</button>
                        </div>
                    </div>
